...
# ─────────────────────────────────────────────
SUMMARY_FILES = {
    "HEUR": "results/my_heuristic/50j_10m/summary_heuristic_T_max.csv",
    "TMIG": "results/tm_ig/50j_10m/summary_T_max.csv",
    "NEHEDD_IT1": "results/nehedd_it1/50j_10m/summary_NEHedd_IT1_T_max.csv",
}

OUTPUT_CSV = "results/aggregated/50j_10m/aggregated_T_max.csv"
OUTPUT_TEX = "results/aggregated/50j_10m/aggregated_T_max.tex"
...
def aggregate_tt():
    ...
    for heur_name, file_path in SUMMARY_FILES.items():
        ...
        tt_col = find_col(df, [
            "T_max", "Objective", "objective", "Value", "value"
        ])
