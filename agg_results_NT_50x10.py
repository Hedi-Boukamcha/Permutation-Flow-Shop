...
# ─────────────────────────────────────────────
SUMMARY_FILES = {
    "HEUR": "results/my_heuristic/50j_10m/summary_heuristic_NT.csv",
    "TMIG": "results/tm_ig/50j_10m/summary_NT.csv",
    "NEHEDD_IT1": "results/nehedd_it1/50j_10m/summary_NEHedd_IT1_NT.csv",
}

OUTPUT_CSV = "results/aggregated/50j_10m/aggregated_NT.csv"
OUTPUT_TEX = "results/aggregated/50j_10m/aggregated_NT.tex"
...
def aggregate_tt():
    ...
    for heur_name, file_path in SUMMARY_FILES.items():
        ...
        tt_col = find_col(df, [
            "NT", "Objective", "objective", "Value", "value"
        ])
